...
TRAINING_RES = "/nfs/dust/cms/user/bukinkir/TauId/XCN/"
...
if __name__ == "__main__":
    ...
    if RESUME_TRAINING:
        net, optimizer, _, _ = load_model('{0}XCN_{1}.pt'.format(TRAINING_RES, EPOCH))
    ...
    log = Logger(TRAINING_RES, 'XCN', RESUME_TRAINING)
    ...
    for epoch in range(EPOCH + 1, 101):
        ...
        torch.save({
            ...
            'optimizer': optimizer,
            'loss': loss,
        }, '{0}XCN_{1}.pt'.format(TRAINING_RES, epoch))
